...
public class FloatingShortcutService extends Service {
    ...
    public void onCreate() {
        ...
        this.startForeground(FloatingShortcutService.class.hashCode(), createNotification());
    }

    private Notification createNotification() {
        Notification noti = new Notification.Builder(this).setContentTitle("Floating Shortcut")
